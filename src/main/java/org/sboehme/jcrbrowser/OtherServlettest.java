...
@Properties({
		...
		@Property(name = "sling.servlet.resourceTypes", value = "servletresourcetype")

})
public class OtherServlettest extends SlingSafeMethodsServlet {

	private static final long serialVersionUID = -1L;

	/** default log */
	private final Logger log = LoggerFactory
			.getLogger(OtherServlettest.class);
	...
	protected void doGet(SlingHttpServletRequest request,
		...
		out.print("Hello, I have been rendered by the 'servletresourcetype' servlet.");
